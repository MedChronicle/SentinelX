...
const navItems: NavItem[] = [
  ...
  {
    id: "incidents", label: "Incidents", badge: 47,
  ...
  {
    id: "alerts", label: "Alerts", badge: 6,
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>
  },
  {
    id: "ml", label: "ML Insights",
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
  },
  {
    id: "audit", label: "Audit Trail",
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
  },
  {
...
export default function Sidebar({ active, onNav, user, onLogout, collapsed, onToggle }: Props) {
  return (
    <aside
    ...
    >
      ...
      {!collapsed && (
        <div className="mx-3 mt-3 mb-1 bg-[#070b14] rounded-lg px-3 py-2 border border-[#1e3058]">
          ...
          <div className="mt-1.5 flex items-center gap-2">
            ...
            <span className="text-[#4a6090] text-xs font-mono">Risk 68</span>
          </div>
        </div>
      )}
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-2.5 py-2.5 rounded-lg transition-all duration-150 text-left group relative
                ${isActive
                  ...
                  : "text-[#4a6090] hover:text-[#e2eaf8] hover:bg-[#111e35] border border-transparent"
                }`}
              ...
              {!collapsed && (
                <>
                  ...
                  {item.badge !== undefined && (
                    <span className={`text-xs font-mono rounded px-1.5 py-0.5 ${isActive ? "bg-[#00d4ff]/20 text-[#00d4ff]" : "bg-[#1e3058] text-[#4a6090]"}`}>
                      {item.badge}
                    </span>
                  )}
                </>
      ...
      <div className="border-t border-[#1e3058] p-3">
        <div className={`flex items-center gap-2.5 ${collapsed ? "justify-center" : ""}`}>
          ...
          {!collapsed && (
            <button onClick={onLogout} className="text-[#4a6090] hover:text-[#ef4444] transition-colors flex-shrink-0" title="Sign out">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
